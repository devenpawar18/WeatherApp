package com.appcelerator.weatherapp.services.utils;
...
import com.appcelerator.weatherapp.utils.TrustAllSSLSocketFactory;
...
public class HTTPRequest {
	...
	public int execute(RequestMethod method) throws Exception {
		 ...
		 */
		if (!WeatherAppUtils.isConnectionAvailable(context))
			return Constants.WeatherAppDialogCodes.NETWORK_ERROR;
